...
class AdaFit_HG(nn.Module):
    ...
    def forward(self, points):
        ...
        return (normal, refine_normal), beta.squeeze(), weights.squeeze(), trans, trans2, (neighbor_normals, refine_neighbor_normals), bias
...
class Net(nn.Module):
    def __init__(self, opt):
        ...
        self.fit = AdaFit_HG(1, opt.points_per_patch,
