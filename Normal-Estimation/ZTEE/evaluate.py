...
parser.add_argument('--normal_results_path', type=str, default='./log/deepfit_adp_wp_k8', help='Log dir [default: log]')
...
parser.add_argument('--dataset_list', type=str,
                    default=['testset_no_noise', 'testset_low_noise', 'testset_med_noise', 'testset_high_noise',
                              'testset_vardensity_gradient', 'testset_vardensity_striped'], nargs='+',
...
normal_results_path = os.path.join(FLAGS.normal_results_path, 'results_599')
